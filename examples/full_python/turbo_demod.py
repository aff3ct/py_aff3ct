...
cstl = aff3ct.tools.constellation.Constellation_user("../../lib/aff3ct/conf/mod/16QAM_GRAY.mod") # Setup constellation tool
mdm  = aff3ct.module.modem.Modem_generic(N, cstl)        # Build the modem

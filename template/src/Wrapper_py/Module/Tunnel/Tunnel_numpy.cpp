...
::definitions()
{
    ...
    this->def("is_append_done", &aff3ct::module::Tunnel_numpy<B>::is_append_done, R"pbdoc()pbdoc");
    this->def("is_get_done", &aff3ct::module::Tunnel_numpy<B>::is_get_done, R"pbdoc()pbdoc");

...
: Wrapper_py(),
  py::class_<aff3ct::module::Monitor_BFER<B>,aff3ct::module::Monitor>(scope, "Monitor_BFER")
{
}
...
::definitions()
{
	...
	this->def("get_n_analyzed_fra", &aff3ct::module::Monitor_BFER<B>::get_n_analyzed_fra);
	this->def("get_n_fe"          , &aff3ct::module::Monitor_BFER<B>::get_n_fe          );
	this->def("get_n_be"          , &aff3ct::module::Monitor_BFER<B>::get_n_be          );
	this->def("get_fer"           , &aff3ct::module::Monitor_BFER<B>::get_fer           );
	this->def("get_ber"           , &aff3ct::module::Monitor_BFER<B>::get_ber           );

...
::definitions()
{
	...
	/*this->def(py::init<const module::Task &, const size_t, const bool, const std::vector<size_t> &>(), "first"_a, "n_threads"_a = 1, "thread_pinning"_a = false, "puids"_a = std::vector<size_t>());
	this->def(py::init<const std::vector<const module::Task *> &, const size_t, const bool, const std::vector<size_t> &>(), "firsts"_a, "n_threads"_a = 1, "thread_pinning"_a = false, "puids"_a = std::vector<size_t>());
	this->def(py::init<const std::vector<const module::Task *> &, const std::vector<const module::Task *> &, const size_t, const bool, const std::vector<size_t> &>(), "firsts"_a, "lasts"_a, "n_threads"_a = 1, "thread_pinning"_a = false, "puids"_a = std::vector<size_t>());
